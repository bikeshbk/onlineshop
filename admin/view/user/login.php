...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo base_url(); ?>user/login"><b>e-Commerce</b>OLS</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Sign in to start your OnLineShopping</p>
    <?php if(isset($this->errLogin)){ ?>
    <div class="alert alert-danger">
    	<?php echo $this->errLogin; ?>
    </div>
     <?php } ?>
    <form action="<?php echo base_url(); ?>user/login" method="post" id="loginForm">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Email OR UserName" name="email" autofocus required>
